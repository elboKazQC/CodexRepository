                        ...
                        if 'ghz' in value:
                            if '2.4' in value or '2,4' in value:
                                ...
                                if "channel" not in current_network:
                                    ...
                                    current_network["channel"] = 36  # On suppose canal 36 par défaut                        elif 'mhz' in value:
                            try:
                                # Extraire la valeur exacte de la fréquence
                                freq_match = re.search(r'(\d+)\s*mhz', value)
                                if freq_match:  # Vérifier que le match existe avant d'accéder au groupe
